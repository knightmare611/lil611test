...
const X_SOCIAL_SVG_CODE = `<svg class="icon-img" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="2.5" y="2.5" width="19" height="19" rx="5" fill="currentColor"/><path d="M7 6.8h3.2l2.2 3.1 2.7-3.1h2.1l-3.8 4.4 4.2 6h-3.2l-2.5-3.6-3.1 3.6H6.7l4.2-4.9L7 6.8Zm2.5 1.4 5.6 7.6h.9l-5.6-7.6h-.9Z" fill="#ffffff"/></svg>`;
...
const NOVEL_SVG_CODE = `<svg class="icon-img" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M5.5 3.5h9.2c1.9 0 3.3 1.4 3.3 3.3v13.7H7.3c-1.8 0-3.3-1.5-3.3-3.3V5c0-.8.7-1.5 1.5-1.5Z" fill="currentColor"/><path d="M7.2 6.4h7.5M7.2 9.3h6.4M7.2 12.2h7.1" stroke="#ffffff" stroke-width="1.4" stroke-linecap="round"/><path d="M7.2 17.4h10.8v3.1H7.2c-.9 0-1.6-.7-1.6-1.6s.7-1.5 1.6-1.5Z" fill="#81AFD9"/></svg>`;
...
const defaultIcons = {
    ...
    'x-social-screen': { name: 'X', url: './icon/rpg.svg', svgCode: RPG_SVG_CODE },
    ...
    'rpg-title-screen': { name: '小说', url: './icon/rpg.svg', svgCode: NOVEL_SVG_CODE },
