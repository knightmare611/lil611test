...
if (groupTimePEl) groupTimePEl.checked = group.timePerceptionEnabled || false;
    const linkedPrivateEl = document.getElementById('setting-group-linked-private-context');
if (linkedPrivateEl) linkedPrivateEl.checked = group.linkedPrivateContextEnabled || false;
...
if (groupTimePEl) group.timePerceptionEnabled = groupTimePEl.checked;
    const linkedPrivateEl = document.getElementById('setting-group-linked-private-context');
if (linkedPrivateEl) group.linkedPrivateContextEnabled = linkedPrivateEl.checked;
