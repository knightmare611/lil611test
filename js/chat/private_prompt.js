...
if (character.callMode === 'voice') {
    ...
    const linkedGroupContext = typeof buildLinkedGroupContextForPrivate === 'function'
        ? buildLinkedGroupContextForPrivate(character)
        : '';
    if (linkedGroupContext) {
        prompt += `${linkedGroupContext}\n\n`;
    }
